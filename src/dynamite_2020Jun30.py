...
class dynamite:
    ...
    def __init__(self):
        ...
        targets_dict = {
            ...
            #"Kepler-20" :([0.93, 0.03, 0.95, 0.08],[86.5, round(0.17*const.R_jup.value/const.R_earth.value, 3), 3.696], [88.39, round(0.274*const.R_jup.value/const.R_earth.value, 3), 10.854], [89.57, round(0.245*const.R_jup.value/const.R_earth.value, 3), 77.612], [87.5, round(0.0774*const.R_jup.value/const.R_earth.value, 3), 6.098], [88.68, round(0.092*const.R_jup.value/const.R_earth.value, 3), 19.577]),     # additional testing
            "Kepler-20" :([0.93, 0.03, 0.95, 0.08], [88.39, round(0.274*const.R_jup.value/const.R_earth.value, 3), 10.854], [89.57, round(0.245*const.R_jup.value/const.R_earth.value, 3), 77.612], [87.5, round(0.0774*const.R_jup.value/const.R_earth.value, 3), 6.098], [88.68, round(0.092*const.R_jup.value/const.R_earth.value, 3), 19.577]),
        ...
        def set_up(target):
            ...
            def get_arccos1(star_pars, planet_pars):
                return round(np.arccos(np.random.rand()/(self.K3(planet_pars[0], star_pars[2])/(star_pars[0]*const.R_sun.cgs.value)))*180/math.pi, 3)
        ...
        # MOVE ALL PLOTTING FUNCTIONALITY TO SEPARATE FILE
        ...
        if self.run_type == "TOI" and not saved:
            ...
            plot_deltas = False
            plot_ratios = False
            plot_period_radius = False      # SHOULD BE TRANSIT DEPTH VS PROBABILITY
            ...
            if plot_period_radius:      # SEE ABOVE
                x = []
    ...
    def run_monte_carlo(self, R_star, Rse, M_star, Mse, target, target_name):
        ...
        if len(inc) == 4:
            incn = [[inc[0], inc[1], inc[2], inc[3]], [inc[0], 180-inc[1], inc[2], inc[3]], [inc[0], inc[1], 180-inc[2], inc[3]], [inc[0], inc[1], inc[2], 180-inc[3]], [inc[0], 180-inc[1], 180-inc[2], inc[3]], [inc[0], 180-inc[1], inc[2], 180-inc[3]], [inc[0], inc[1], 180-inc[2], 180-inc[3]], [inc[0], 180-inc[1], 180-inc[2], 180-inc[3]]]
